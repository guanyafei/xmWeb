define([
    ...
    angular.module('xwWeb')
        .registerController('mainController', ['$rootScope','CONFIG', 'authService', 'businessService','errorService', '$timeout', mainController]);

    function mainController($rootScope, CONFIG, authService, businessService, errorService, $timeout) {

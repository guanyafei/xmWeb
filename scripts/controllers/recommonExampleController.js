...
define([
    ...
    angular.module('xwWeb')
        .registerController('recommonExampleController', ['$scope','$stateParams', 'CONFIG', 'authService', 'exampleService','industryService','districtService', 'errorService', 'serviceService', 'utilService', recommonExampleController]);

    function recommonExampleController($scope,$stateParams , CONFIG, authService, exampleService,industryService, districtService,errorService, serviceService, utilService) {
        ...
        function queryExample(isValid){
            ...
            if((vm.minArea && !vm.maxArea) || (vm.minRent && !vm.maxRent) || !isValid){
                return;
            }
            vm.query=true;
